...
const createComparisonFunction = require('./create_comparison_function');
...
function listCategoriesHelper(categories, options) {
  ...
  const prepareQuery = parent => {
    ...
    return categories.find(query).sort(createComparisonFunction(orderby, order)).filter(cat => cat.length);
  };
